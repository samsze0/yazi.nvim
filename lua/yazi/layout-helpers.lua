...
-- Create yazi layout
--
---@alias YaziCreateSinglePaneLayoutOptions { main_popup?: YaziMainPopup, help_popup?: YaziHelpPopup }
---@param controller YaziController
---@param opts YaziCreateSinglePaneLayoutOptions
---@return YaziSinglePaneLayout
M.create_single_pane_layout = function(controller, opts)
  opts = opts_utils.deep_extend({}, opts)
  ---@cast opts YaziCreateSinglePaneLayoutOptions
