...
---@alias YaziCallback function

---@class YaziCallbackMap
---@field private value table<string, YaziCallback> Callback map
local CallbackMap = {}
CallbackMap.__index = CallbackMap

---@param base? YaziCallbackMap
---@return YaziCallbackMap self
